  ...
  <header>
    <div class="container mx-auto py-3">
      <div class="navbar py-2">
        <div class="navbar__top flex items-center justify-between">
          ...
          <div class="navbar__contact flex items-center gap-4">
        ...
        <div class="navbar__bottom mt-4" ref="navbarFix">
