  ...
  <section class="footer_top_section bg-[#E3ECF5] py-10">
    <div class="container">
      ...
      <div class="top_section_content">
        <ul
          class="top_section_cards flex sm:justify-center sm:gap-4 sm:gap-y-[56px] justify-between sm:flex-wrap"
        >
          <ul
            class="top_section_card sm:w-[45%] w-[20%] bg-white p-3 rounded-lg shadow-xl"
          >
